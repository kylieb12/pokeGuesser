...
#using global helps us to modify the pokeLeft list outside of the function
    ...
    def ans_ind():
        ...
        # This line stops the previous music
        pygame.mixer.music.stop
        # This line loads the following song
        mixer.music.load("congrats.mp3")
        # This line plays the following song
        mixer.music.play()
        # This line gets the path to the picture of the pokemon that Dr. Oak guessed.
...
print("bulby")
pokeDict["Bulbasaur"].describe
#pokemon left to guess
pokeLeft = []
for i in pokeDict:
    pokeLeft.append(pokeDict[i].name)
